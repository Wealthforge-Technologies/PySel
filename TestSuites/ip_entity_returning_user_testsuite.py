...
from testcases.IPCases import ip_investor_type_entity_returning_testcase
from testcases.IPCases import ip_investor_registration_entity_returning_testcase
from testcases.IPCases import ip_employstatus_testcase
from testcases.IPCases import ip_investor_entity_accredidation_testcase
...
def main():
    ...
    suite.addTests([loader.loadTestsFromModule(set_window_size),
                    ...
                    loader.loadTestsFromModule(ip_investor_type_entity_returning_testcase),
                    loader.loadTestsFromModule(ip_investor_registration_entity_returning_testcase),
                    loader.loadTestsFromModule(ip_employstatus_testcase),
                    loader.loadTestsFromModule(ip_investor_entity_accredidation_testcase),
