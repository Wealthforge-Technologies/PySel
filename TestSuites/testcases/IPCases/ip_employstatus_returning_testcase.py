...
class TestIPEmploymentStatus(unittest.TestCase):
    ...
    def test_login(self):
        ...
        ip_employstatus_returning_page = IPEmploymentStatusPage()
        ip_employstatus_returning_page.is_expected_landing_url()


        ip_employstatus_returning_page.verify_info(self.lookup.testinfo['Employment Status'],
