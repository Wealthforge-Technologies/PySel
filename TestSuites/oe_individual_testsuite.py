...
from testcases.IPCases import oe_investment_individual_testcase
from testcases.IPCases import oe_investor_individual_testcase
...
def main():
    ...
    suite.addTests([loader.loadTestsFromModule(set_window_size),
                    ...
                    loader.loadTestsFromModule(oe_investment_individual_testcase),
                    loader.loadTestsFromModule(oe_investor_individual_testcase),
